...
#define PLL0CFG_Val           0x0000000F//BM-1后的值（PLL0经过16倍频，Fcco为384M）
#define PLL1_SETUP            0//禁止掉PLL1
#define PLL1CFG_Val           0x00000000//
#define CCLKCFG_Val           0x00000007//7N-1后的值(Fcco经过4分频得到96M)
#define USBCLKCFG_Val         0x00000007//
#define PCLKSEL0_Val          0x00000000//0xAAA2A2AA外设分频可以通过位值去选择
