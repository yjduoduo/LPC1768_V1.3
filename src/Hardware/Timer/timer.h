...
/* TIME_INTERVALmS is a value to load the timer match register with
   to get a 100 uS delay */
#define TIME_INTERVALuS	100

//#define TIME_INTERVAL	(9000000/100 - 1)
#define TIME_INTERVAL  2500	  //if PLL0=400M, then CCLK=100M,PCLK=25M

extern void delayMs(uint8 timer_num, uint32 delayInMs);
extern uint32 init_timer(uint8 timer_num, uint32 timerInterval );
extern void Init_timer0(void);
extern uint32 init_timer1(uint8 timer_num) ;
