#line 1 "..\\src\\Share\\CSetCurrent.c"
...
#line 15 "..\\src\\Share\\CSetCurrent.c"
...
#line 16 "..\\src\\Share\\CSetCurrent.c"


void State_0mA(void)
{	
	(*(volatile unsigned long *)(0x2009C000 + 0x18)) |= (1<<22)|(1<<21);	
}
void State_6mA(void)
{
...
{
	(*(volatile unsigned long *)(0x2009C000 + 0x1C)) |= (1<<22) | (1<<21);	
}
