#line 1 "..\\src\\11DisMenu\\alarmenu.c"
...
#line 15 "..\\src\\11DisMenu\\alarmenu.c"
#line 1 "..\\src\\11DisMenu\\alarmenu.h"
...
#line 16 "..\\src\\11DisMenu\\alarmenu.c"
...
#line 17 "..\\src\\11DisMenu\\alarmenu.c"
...
void Alarm_Menu(uint8 depart,uint8 compent,uint8 cirAddr,uint16 sum,uint8 type,PCF8563_DATE timed)
{
	...
	if((depart != 0)&&(compent !=0))
	{
		...
		Displaynumber(1,0,40,(depart%100/10));
		Displaynumber(1,0,48,(depart%10));
		Displaynumber(1,0,56,0x0C);
		Displaynumber(2,0,0,(compent%100/10));
		Displaynumber(2,0,8,(compent%10));
		...
		Displaynumber(1,2,56,(cirAddr%10));
		
		DisplayJBHZK(2,2,0,((hz[8]<<8)+hz[9]));
		DisplayJBHZK(2,2,16,((hz[10]<<8)+hz[11])); 	 
		Displaynumber(2,2,32,0x0A);	
		Displaynumber(2,2,40,(sum/100));
		Displaynumber(2,2,48,(sum%100/10));
		Displaynumber(2,2,56,(sum%10));
