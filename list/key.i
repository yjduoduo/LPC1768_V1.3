...
#line 29 "..\\src\\Board\\key.c"

#line 36 "..\\src\\Board\\key.c"
...
{ 
	...
	if(!((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 11)))
	{
        ...
        if(!((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 11)))
        {
            ...
            if(GetDisplay_alarm_flag())
                Led_Silence_On();
            OpenLCD();
            while(((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 11)));
            Delay1Ms(15); 
            while(((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 11)));
            return;
	...
	if(!((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 25)))
	{
        ...
        if(!((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 25)))
        {
            ...
            if(!GetDisplay_alarm_flag())
                Led_Silence_Off();
            OpenLCD();
            while(((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 25)));
            Delay1Ms(15); 
            while(((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 25)));
            return;
	...
	if(!((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 26)))
	{
        ...
        if(!((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 26)))
        {
            ...
            OpenLCD();
            while(((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 26)));
            Delay1Ms(15); 
            while(((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 26)));
            return;
	...
	if(!((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 30)))
	{
        ...
        if(!((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 30)))
        {
            ...
            OpenLCD();
            while(((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 30)));
            Delay1Ms(15); 
            while(((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 30)));
            return;
	...
	if(!((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 29)))
	{
        ...
        if(!((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 29)))
        {
            ...
            OpenLCD();
            while(((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 29)));
            Delay1Ms(15); 
            while(((*(volatile unsigned long *)(0x2009C000 + 0x14))&(1 << 29)));
            return;
