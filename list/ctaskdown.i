#line 1 "..\\src\\20RunCtrl\\CTaskDown.c"
...
#line 16 "..\\src\\20RunCtrl\\CTaskDown.c"
...
#line 17 "..\\src\\20RunCtrl\\CTaskDown.c"
...
#line 18 "..\\src\\20RunCtrl\\CTaskDown.c"
...
#line 19 "..\\src\\20RunCtrl\\CTaskDown.c"
...
#line 20 "..\\src\\20RunCtrl\\CTaskDown.c"
...
#line 21 "..\\src\\20RunCtrl\\CTaskDown.c"
...
#line 22 "..\\src\\20RunCtrl\\CTaskDown.c"
...
#line 23 "..\\src\\20RunCtrl\\CTaskDown.c"
	...
	switch(GetCounter2())
	{
		...
		case 3:
			...
			if(++vHisCountDown<1000)
			{
				...
				{
					num=GetHistoryList((GetHistConter()-vHisCountDown),0);
					address=GetPSNFormFlash(num,7);
					type=GetHistoryList((GetHistConter()-vHisCountDown),1);
					alarmtype=GetHistoryList((GetHistConter()-vHisCountDown),3);
					row=GetHistoryList((GetHistConter()-vHisCountDown),11);
					TimeAndDate.year=(GetHistoryList((GetHistConter()-vHisCountDown),4)<<8)+GetHistoryList((GetHistConter()-vHisCountDown),5);
					TimeAndDate.month=GetHistoryList((GetHistConter()-vHisCountDown),6);
					TimeAndDate.day=GetHistoryList((GetHistConter()-vHisCountDown),7);
					TimeAndDate.hour=GetHistoryList((GetHistConter()-vHisCountDown),8);
					TimeAndDate.minute=GetHistoryList((GetHistConter()-vHisCountDown),9);
					TimeAndDate.second=GetHistoryList((GetHistConter()-vHisCountDown),10);
				}
				else
				{
					if(++vHistCount<(1000-GetHistConter()))
					num=GetHistoryList((1000-vHistCount),0);
					address=GetPSNFormFlash(num,7);
					type=GetHistoryList((1000-vHistCount),1);
					alarmtype=GetHistoryList((1000-vHistCount),3);
					row=GetHistoryList((1000-vHistCount),11);
					TimeAndDate.year=(GetHistoryList((1000-vHistCount),4)<<8)+GetHistoryList((1000-vHistCount),5);
					TimeAndDate.month=GetHistoryList((1000-vHistCount),6);
					TimeAndDate.day=GetHistoryList((1000-vHistCount),7);
					TimeAndDate.hour=GetHistoryList((1000-vHistCount),8);
					TimeAndDate.minute=GetHistoryList((1000-vHistCount),9);
					TimeAndDate.second=GetHistoryList((1000-vHistCount),10);
				}
