#line 1 "..\\src\\Share\\CFlashParam.c"
...
#line 16 "..\\src\\Share\\CFlashParam.c"
...
#line 16 "..\\src\\Share\\CFlashParam.h"
	...
	uint8 vGetDatatoFlash[100][13]={0};
	uint8 vGetDepNum[50]={0};
	uint8 vReadFlashData[16]={0};

	uint8 vGetPsn[100][8]={0};
	uint8 vSendPSNToFlash[100][8]={0};
	uint8 vCirCounter=0;
...
#line 17 "..\\src\\Share\\CFlashParam.c"
...
void GetFlashPsn(void)
{
	...
	for(i=0;i<100;i++)
		...
		for(j=0;j<4;j++)
			vGetPsn[i][j]=M25P80_Read_1Byte(0x30000+16*i+j);
