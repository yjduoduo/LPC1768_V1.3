...
void  Eint1_Init(void)
{
	(*(volatile unsigned long *)(0x4002C000 + 0x10)) |= (1 << 22);

	(*(volatile unsigned long *)(0x400FC000 + 0x148))  |= 1 << 1;           
	(*(volatile unsigned long *)(0x400FC000 + 0x14C)) &= ~(1 << 1);	
...
{    
	...
	(*(volatile unsigned long *)(0x4002C000 + 0x04)) &=~(0x03<14);
	(*(volatile unsigned long *)(0x2009C000 + 0x00))  &= (~ (0x01<<23)) ;  
